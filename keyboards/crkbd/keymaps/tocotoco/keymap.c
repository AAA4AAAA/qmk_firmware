...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_ADJUST] = LAYOUT_kc( \
  //,-----------------------------------------.                ,-----------------------------------------.
        RST,  RRST, XXXXX, XXXXX, XXXXX,    F1,                     F2,    F3,    F4,    F5,    F6,   LCK,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
       RTOG,  RHUI,  RSAI,  RVAI, XXXXX,    F7,                     F8,    F9,   F10,   F11,   F12,  PSCR,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
       RMOD,  RHUD,  RSAD,  RVAD, XXXXX, XXXXX,                  XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, SPSCR,\
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
                                  _____, _____, _____,    _____, _____, _____ \
                              //`--------------------'  `--------------------'
